...
- Target distro: Ubuntu 24.04 ARM64
- Kernel line: Linux 6.8
- Default kernel version: auto-detect latest `6.8.x`
...
- `.github/workflows/build-ubuntu2404-bbrplus-arm64.yml`
...
- `Actions -> Build Ubuntu 24.04 BBRplus ARM64 Kernel -> Run workflow`
...
KERNEL_VERSION=6.8.12 bash scripts/build-ubuntu2404-bbrplus-arm64.sh
```
...
如果目标机器是 Ubuntu 24.04 ARM64，请用对应脚本：
...
```bash
cd /path/to/kernel-debs
sudo bash install-ubuntu2404-bbrplus-arm64.sh --enable-bbrplus
```
...
- `convert_official_linux-6.8.x_src_to_bbrplus.patch`

The original upstream note is preserved in:

- `patches/6.8/README-upstream.txt`
...
- `https://ports.ubuntu.com/pool/main/l/linux-oracle-6.17/linux-headers-6.17.0-1011-oracle_6.17.0-1011.11~24.04.1_arm64.deb`
