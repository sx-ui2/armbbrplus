...
KERNEL_VERSION="${KERNEL_VERSION:-6.8.12}"
KERNEL_MAJOR="${KERNEL_MAJOR:-6}"
KERNEL_SERIES="${KERNEL_SERIES:-6.8}"
LOCALVERSION="${LOCALVERSION:--bbrplus}"
PKGREV="${PKGREV:-1}"
ORACLE_KERNEL_SERIES="${ORACLE_KERNEL_SERIES:-linux-oracle-6.17}"
ORACLE_BASE_RELEASE="${ORACLE_BASE_RELEASE:-6.17.0-1011-oracle}"
ORACLE_PKG_VERSION="${ORACLE_PKG_VERSION:-6.17.0-1011.11~24.04.1}"
...
PATCH_DIR="${ROOT_DIR}/patches/6.8"
FRAGMENT="${ROOT_DIR}/configs/ubuntu2404-arm64.fragment"
...
cd "${PATCHED_DIR}"
patch -p1 --forward < "${PATCH_DIR}/convert_official_linux-6.8.x_src_to_bbrplus.patch"
