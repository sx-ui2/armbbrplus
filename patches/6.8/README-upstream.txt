...
### 1) get convert patch on this repository, use git or direct download
        (e.g., convert_official_linux-6.8.x_src_to_bbrplus.patch)
...
### 3) extract the tarball & cd extracted directory
        tar xvf linux-6.8.12.tar.xz && cd linux-6.8.12
...
### 4) copy convert patch to extracted kernel directory
        something like
            cp ../convert_official_linux-6.8.x_src_to_bbrplus.patch .

<br/>
<br/>

### 5) do the patch job
        patch -p1 < convert_official_linux-6.8.x_src_to_bbrplus.patch
